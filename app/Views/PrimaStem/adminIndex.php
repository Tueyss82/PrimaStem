...
<div class="container-xxl">
    ...
    <div class="row">
        <div class="col-md-6 text-center">
            ...
            <a class="btn btn-danger" href="<?= url_to('supprArticleIndex') ?>">Supprimer un article</a>
        </div>
        <div class="col-md-6 text-center">
            ...
            <a class="btn btn-danger" href="<?= url_to('supprPartenaireIndex') ?>">Supprimer un partenaire</a>
        </div>
    </div>
</div>
