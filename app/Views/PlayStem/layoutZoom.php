...
<header>
    ...
    <link rel="stylesheet" type="text/css" hrpe="text/css" href="../css/mainPlayStem.css">
    <link rel="stylesheet" tyef="../css/playstem-leçon.css">
...
<body>
    <?= $this->renderSection('contenuZoom') ?>
