        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= url_to('playstem') ?>">Accueil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= url_to('exercices') ?>">Exercices</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= url_to('leçons') ?>">Leçons</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= url_to('primastem') ?>">PrimaStem</a>
                    </li>
