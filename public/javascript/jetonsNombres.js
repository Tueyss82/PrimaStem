...
nombres.addEventListener("click", function (event) {
    ...
    while (limiteJetonsNombres < 1) {
        ...
        imgJeton1.setAttribute('id', 'imgJeton1');
        imgJeton1.setAttribute('ondragstart', 'drag(event)');
        ...
        imgJeton1.setAttribute('id', 'imgJeton2');
        ...
        imgJeton1.setAttribute('id', 'imgJeton3');
        ...
        imgJeton1.setAttribute('id', 'imgJeton4');
        ...
        imgJeton1.setAttribute('id', 'imgJeton5');
        ...
        imgJeton1.setAttribute('id', 'imgJeton6');
        ...
        imgJeton1.setAttribute('id', 'imgJeton7');
        ...
        imgJeton1.setAttribute('id', 'imgJeton8');
        ...
        imgJeton1.setAttribute('id', 'imgJeton9');
        ...
        imgJeton1.setAttribute('id', 'imgJeton10');
        ...
        imgJeton1.setAttribute('id', 'imgJeton15');
        ...
        imgJeton1.setAttribute('id', 'imgJeton20');
        ...
        imgJeton1.setAttribute('id', 'imgJeton36');
        ...
        imgJeton1.setAttribute('id', 'imgJeton40');
        ...
        imgJeton1.setAttribute('id', 'imgJeton45');
        ...
        imgJeton1.setAttribute('id', 'imgJeton50');
        ...
        imgJeton1.setAttribute('id', 'imgJeton60');
        ...
        imgJeton1.setAttribute('id', 'imgJeton72');
        ...
        imgJeton1.setAttribute('id', 'imgJeton90');
        ...
        imgJeton1.setAttribute('id', 'imgJeton100');
        ...
        imgJeton1.setAttribute('id', 'imgJeton108');
        ...
        imgJeton1.setAttribute('id', 'imgJeton120');
        ...
        imgJeton1.setAttribute('id', 'imgJeton135');
        ...
        imgJeton1.setAttribute('id', 'imgJeton144');
        ...
        imgJeton1.setAttribute('id', 'imgJeton150');
        ...
        imgJeton1.setAttribute('id', 'imgJeton180');
        ...
        imgJeton1.setAttribute('id', 'imgJeton360');
        jeton360.prepend(imgJeton360);

        
            limiteJetonsNombres++;

            // if ((mouvement.onclick)) {
